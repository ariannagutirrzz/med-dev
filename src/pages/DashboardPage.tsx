					...
					<div className="p-6">
						<div className="mb-6 flex justify-between items-center">
							<div>
								...
								<p className="text-gray-600 mt-2">Programa y administra citas médicas</p>
							</div>
						...
						<div className="bg-white rounded-2xl shadow-lg p-4 mb-6">
							<div className="flex flex-wrap gap-4">
								...
								<button type="button" className="px-4 py-2 border border-gray-300 rounded-lg flex items-center gap-2 hover:bg-gray-50">
								...
								<div className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
									<div className="flex justify-between items-start">
										<div className="flex gap-4">
											...
											<div>
												<h4 className="font-semibold text-gray-800">Dr. María González</h4>
												<p className="text-gray-600 text-sm">Consulta General</p>
								...
								<div className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
									<div className="flex justify-between items-start">
										<div className="flex gap-4">
											...
											<div>
												<h4 className="font-semibold text-gray-800">Dr. Carlos Rodríguez</h4>
												<p className="text-gray-600 text-sm">Seguimiento</p>
												<div className="flex items-center gap-4 mt-2 text-sm text-gray-500">
													<span className="flex items-center gap-1">
														<FaClock className="w-4 h-4" />
														2:30 PM
								...
								<div className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
									<div className="flex justify-between items-start">
										<div className="flex gap-4">
											...
											<div>
												<h4 className="font-semibold text-gray-800">Dr. Laura Fernández</h4>
												<p className="text-gray-600 text-sm">Consulta Especializada</p>
												<div className="flex items-center gap-4 mt-2 text-sm text-gray-500">
													<span className="flex items-center gap-1">
														<FaClock className="w-4 h-4" />
														4:00 PM
						...
						{/* Formulario de nueva cita (oculto por defecto, solo para mostrar el diseño) */}
						<div className="mt-6 bg-white rounded-2xl shadow-lg p-6">
							<h3 className="text-lg font-semibold text-gray-800 mb-4">Nueva Cita</h3>
							<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
								<div>
									<label htmlFor="appointment-patient" className="block text-sm font-medium text-gray-700 mb-2">Paciente</label>
									<select id="appointment-patient" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary">
										<option>Seleccionar paciente...</option>
									</select>
								</div>
								<div>
									<label htmlFor="appointment-doctor" className="block text-sm font-medium text-gray-700 mb-2">Médico</label>
									<select id="appointment-doctor" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary">
										<option>Seleccionar médico...</option>
									</select>
								</div>
								<div>
									<label htmlFor="appointment-date" className="block text-sm font-medium text-gray-700 mb-2">Fecha</label>
									<input
										id="appointment-date"
										type="date"
								...
								<div>
									<label htmlFor="appointment-time" className="block text-sm font-medium text-gray-700 mb-2">Hora</label>
									<input
										id="appointment-time"
										type="time"
										className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
								...
								<div className="md:col-span-2">
									<label htmlFor="appointment-reason" className="block text-sm font-medium text-gray-700 mb-2">Motivo</label>
									<textarea
							...
							<div className="mt-4 flex justify-end gap-3">
								...
								<button type="button" className="px-6 py-2 bg-primary text-white rounded-lg hover:bg-primary-dark">
									Guardar Cita
								</button>
							</div>
						</div>
